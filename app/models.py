...
class Device(db.Model):
    ...
    appCode = db.Column(CHAR(10), db.Foreingnkey('td_app.code'), default='NULL', index=True)
    appTagType = db.Column(CHAR(1), nullable=False, default='H')
    ...
    serviceTermVersion = db.Column(VARCHAR(20), db.Freingkey('td_servive_term.version'), default='NULL', index=True)
    locationTermVersion = db.Column(VARCHAR(20), db.Freingkey('td_location_term.version'), default='NULL', index=True)
